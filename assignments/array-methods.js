...
runners.forEach(function (y) {
    allCaps.push(y.first_name.toUpperCase());
    
});
//*****not sure if you wanted a list of just the first names or to change the first names in the original array,
console.log(allCaps); 
...
let largeShirts = [];
runners.filter(function(xx) {
    if( xx.shirt_size === 'L') {
        largeShirts.push(xx);
    }
})
//**************** my console list 6 objects which is the correct amount of L shirts,
//does not list speciifc information
